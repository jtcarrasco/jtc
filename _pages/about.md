...
At [Edlio](https://www.edlio.com), I worked on more than 350 websites built on bespoke codebases across a range of languages and stacks, all in the education sector. The roles consistently blurred across development, design, and production coordination, because most interesting projects don't stay neatly inside one lane.

Outside of that, I've built and maintained multiple WordPress sites for clients ranging from small businesses to large organizations. A lot of that work has involved complex content ecosystems: enrollment workflows, multi-site production systems, and ongoing maintenance that keeps the internet running without anyone noticing. My focus is on work that's functional, maintainable, and doesn't require a manual to hand off.
